...
@section('content')
            ...
            <fieldset class="form-input m-b">
                ...
                <div id="ingredients-container">
                    <div class="ingredient-item">
                        ...
                        <input type="text" name="ingredient_quantity[]" placeholder="Количество" required>
    ...
    <script>
        ...
        document.getElementById('add-ingredient').addEventListener('click', () => {
            ...
            <div class="ingredient-item">
                <input type="text" name="ingredients[${count}][name]" placeholder="Название" required>
                <input type="text" name="ingredients[${count}][quantity]" placeholder="Количество" required>
