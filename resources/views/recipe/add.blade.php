    ...
    <body class="container" style="padding-top: 20px">
            ...
            <form action="{{ route('recipes_store') }}" method="post" enctype="multipart/form-data">
                ...
                <div>
                    <label class="new-recipes-photo">
                        ...
                        <img id="imagePreview" src="{{asset('images/new-photo.svg')}}" alt="new-photo"
                        ...
                        <div id="instructionText">
                            ...
                            <p>Пожалуйста, используйте только свои авторские фотографии. Допустимые форматы фотографий для
                                загрузки: JPEG, JPG, PNG</p>
                        </div>
                    </label>
                    @error('photo')
                        <div class="error">
                ...
                <fieldset class="form-input m-b">
                    ...
                    <div id="steps-container">
                        <div class="step-item">
                            ...
                            <input type="file" name="step_photos[]" accept="image/jpeg, image/jpg, image/png"
        ...
        <script>
            ...
            <div class="step-item">
                <input type="text" name="steps[]" placeholder="Шаг приготовления" required>
                <input type="file" name="step_photos[]" accept="image/jpeg, image/jpg, image/png" class="step-photo-input">
